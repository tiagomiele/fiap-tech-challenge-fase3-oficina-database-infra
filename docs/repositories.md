...
- [Aplicação principal e migrations](https://github.com/tiagomiele/fiap-tech-challenge-fase3-oficina-backend)
- [Autenticação serverless](https://github.com/tiagomiele/fiap-tech-challenge-fase3-oficina-auth-serverless)
- [Infraestrutura Kubernetes e rede](https://github.com/tiagomiele/fiap-tech-challenge-fase3-oficina-kubernetes-infra)
